          ...
          <div className="flex flex-1 items-center justify-center overflow-hidden p-roomy">
            <div className="w-full overflow-hidden rounded-xl border border-[var(--color-border)]">
              <div className="grid grid-cols-[64px_repeat(3,minmax(0,1fr))] bg-[var(--color-surface-alt)] text-xs font-medium text-[var(--color-text-muted)]">
                ...
                <span className="border-r border-[var(--color-border)] px-comfy py-cozy">Mon</span>
                <span className="border-r border-[var(--color-border)] px-comfy py-cozy">Tue</span>
                <span className="px-comfy py-cozy">Wed</span>
              </div>
