...
export default function Sidebar() {
  ...
  const toggleButton = (
    <button
      ...
      className={`flex items-center w-full py-snug rounded-lg text-[13px] font-medium text-[var(--color-text-muted)] hover:bg-[var(--color-border)]/40 hover:text-[var(--color-text)] transition-colors duration-200 ease-in-out ${
  ...
  return (
    <aside
      className={`shrink-0 border-r border-[var(--color-border)] p-base hidden md:flex md:flex-col justify-between transition-all duration-200 ease-in-out ${
        collapsed ? "w-14 px-base" : "w-52 px-base"
      }`}
    >
      ...
      <div className="pt-base border-t border-[var(--color-border)]">
